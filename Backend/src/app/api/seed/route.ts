  ...
  try {
    const result = await db.$transaction(async (tx) => {
      ...
      const accountDefs: AccountDef[] = [
        ...
        { code: '1.2.02.001', name: 'Dep. Edificios', accountType: 'ASSET', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '1.2.02', description: 'CONTRA-ACCOUNT' },
        { code: '1.2.02.002', name: 'Dep. Mobiliario y Equipo', accountType: 'ASSET', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '1.2.02', description: 'CONTRA-ACCOUNT' },

        // === PASIVO (2) ===
        { code: '2', name: 'Pasivo', accountType: 'LIABILITY', nature: 'CREDITOR', level: 1, isGroup: true, parentCode: null },
        { code: '2.1', name: 'Pasivo Corriente', accountType: 'LIABILITY', nature: 'CREDITOR', level: 2, isGroup: true, parentCode: '2' },
        { code: '2.2', name: 'Pasivo No Corriente', accountType: 'LIABILITY', nature: 'CREDITOR', level: 2, isGroup: true, parentCode: '2' },
        { code: '2.1.01', name: 'Proveedores', accountType: 'LIABILITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '2.1' },
        { code: '2.1.02', name: 'Impuestos por Pagar', accountType: 'LIABILITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '2.1' },
        { code: '2.1.03', name: 'Cuentas por Pagar', accountType: 'LIABILITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '2.1' },
        { code: '2.2.01', name: 'Préstamos a Largo Plazo', accountType: 'LIABILITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '2.2' },
        { code: '2.1.01.001', name: 'Proveedores Nacionales', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.1.01' },
        { code: '2.1.01.002', name: 'Proveedores Internacionales', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.1.01' },
        { code: '2.1.02.001', name: 'IVA por Pagar', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.1.02' },
        { code: '2.1.02.002', name: 'ISR por Pagar', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.1.02' },
        { code: '2.1.03.001', name: 'Acreedores Diversos', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.1.03' },
        { code: '2.1.03.002', name: 'Sueldos por Pagar', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.1.03' },
        { code: '2.2.01.001', name: 'Préstamo Bancario', accountType: 'LIABILITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '2.2.01' },

        // === PATRIMONIO (3) ===
        { code: '3', name: 'Patrimonio', accountType: 'EQUITY', nature: 'CREDITOR', level: 1, isGroup: true, parentCode: null },
        { code: '3.1', name: 'Capital', accountType: 'EQUITY', nature: 'CREDITOR', level: 2, isGroup: true, parentCode: '3' },
        { code: '3.2', name: 'Resultados', accountType: 'EQUITY', nature: 'CREDITOR', level: 2, isGroup: true, parentCode: '3' },
        { code: '3.1.01', name: 'Capital Social', accountType: 'EQUITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '3.1' },
        { code: '3.2.01', name: 'Resultado del Ejercicio', accountType: 'EQUITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '3.2' },
        { code: '3.2.02', name: 'Resultados de Ejercicios Anteriores', accountType: 'EQUITY', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '3.2' },
        { code: '3.1.01.001', name: 'Capital Social Autorizado', accountType: 'EQUITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '3.1.01' },
        { code: '3.2.01.001', name: 'Utilidad Neta del Ejercicio', accountType: 'EQUITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '3.2.01' },
        { code: '3.2.02.001', name: 'REA Acumulados', accountType: 'EQUITY', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '3.2.02' },

        // === INGRESO (4) ===
        { code: '4', name: 'Ingreso', accountType: 'INCOME', nature: 'CREDITOR', level: 1, isGroup: true, parentCode: null },
        { code: '4.1', name: 'Ingresos Operacionales', accountType: 'INCOME', nature: 'CREDITOR', level: 2, isGroup: true, parentCode: '4' },
        { code: '4.2', name: 'Ingresos No Operacionales', accountType: 'INCOME', nature: 'CREDITOR', level: 2, isGroup: true, parentCode: '4' },
        { code: '4.1.01', name: 'Ventas', accountType: 'INCOME', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '4.1' },
        { code: '4.1.02', name: 'Ingresos por Servicios', accountType: 'INCOME', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '4.1' },
        { code: '4.2.01', name: 'Otros Ingresos', accountType: 'INCOME', nature: 'CREDITOR', level: 3, isGroup: true, parentCode: '4.2' },
        { code: '4.1.01.001', name: 'Ventas de Contado', accountType: 'INCOME', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '4.1.01' },
        { code: '4.1.01.002', name: 'Ventas de Crédito', accountType: 'INCOME', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '4.1.01' },
        { code: '4.1.02.001', name: 'Servicios de Consultoría', accountType: 'INCOME', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '4.1.02' },
        { code: '4.2.01.001', name: 'Intereses Ganados', accountType: 'INCOME', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '4.2.01' },
        { code: '4.2.01.002', name: 'Ganancia por Cambio Monetario', accountType: 'INCOME', nature: 'CREDITOR', level: 4, isGroup: false, parentCode: '4.2.01' },
