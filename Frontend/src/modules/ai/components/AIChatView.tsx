...
export function AIChatView() {
  ...
  const handleDownloadResponse = async (content: string, index: number) => {
    toast.loading('Generando reporte ejecutivo con gráficas...', { id: 'export-loading' });
    try {
      ...
      toast.success('Reporte con gráficas descargado', { id: 'export-loading' });
    } catch (error) {
      toast.error('Error al generar reporte pro', { id: 'export-loading' });
    }
  };
