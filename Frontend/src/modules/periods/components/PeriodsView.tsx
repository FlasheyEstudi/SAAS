...
interface Period { id: string; name: string; startDate: string; endDate: string; status: 'OPEN' | 'CLOSED' | 'LOCKED'; year: number; month: number; entryCount: number; }

const mockPeriods: Period[] = [
  { id: '1', name: 'Enero 2025', startDate: '2025-01-01', endDate: '2025-01-31', status: 'CLOSED', year: 2025, month: 1, entryCount: 45 },
  { id: '2', name: 'Febrero 2025', startDate: '2025-02-01', endDate: '2025-02-28', status: 'CLOSED', year: 2025, month: 2, entryCount: 38 },
  { id: '3', name: 'Marzo 2025', startDate: '2025-03-01', endDate: '2025-03-31', status: 'CLOSED', year: 2025, month: 3, entryCount: 52 },
  { id: '4', name: 'Abril 2025', startDate: '2025-04-01', endDate: '2025-04-30', status: 'CLOSED', year: 2025, month: 4, entryCount: 41 },
  { id: '5', name: 'Mayo 2025', startDate: '2025-05-01', endDate: '2025-05-31', status: 'CLOSED', year: 2025, month: 5, entryCount: 37 },
  { id: '6', name: 'Junio 2025', startDate: '2025-06-01', endDate: '2025-06-30', status: 'OPEN', year: 2025, month: 6, entryCount: 29 },
  { id: '7', name: 'Julio 2025', startDate: '2025-07-01', endDate: '2025-07-31', status: 'OPEN', year: 2025, month: 7, entryCount: 12 },
  { id: '8', name: 'Agosto 2025', startDate: '2025-08-01', endDate: '2025-08-31', status: 'OPEN', year: 2025, month: 8, entryCount: 3 },
  { id: '9', name: 'Septiembre 2025', startDate: '2025-09-01', endDate: '2025-09-30', status: 'OPEN', year: 2025, month: 9, entryCount: 0 },
  { id: '10', name: 'Octubre 2025', startDate: '2025-10-01', endDate: '2025-10-31', status: 'OPEN', year: 2025, month: 10, entryCount: 0 },
  { id: '11', name: 'Noviembre 2025', startDate: '2025-11-01', endDate: '2025-11-30', status: 'OPEN', year: 2025, month: 11, entryCount: 0 },
  { id: '12', name: 'Diciembre 2025', startDate: '2025-12-01', endDate: '2025-12-31', status: 'OPEN', year: 2025, month: 12, entryCount: 0 },
];
...
export function PeriodsView() {
  ...
  useEffect(() => { setTimeout(() => { setPeriods(mockPeriods); setLoading(false); }, 500); }, []);

  const handleClose = () => {
    if (!confirmAction) return;
    setPeriods(prev => prev.map(p => p.id === confirmAction.id ? { ...p, status: 'CLOSED' as const } : p));
  ...
  const handleReopen = () => {
    if (!confirmAction) return;
    setPeriods(prev => prev.map(p => p.id === confirmAction.id ? { ...p, status: 'OPEN' as const } : p));
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {periods.map((period, i) => (
            ...
            >
              ...
              <p className="text-[10px] text-vintage-500 mt-0.5">{period.entryCount} pólizas</p>
            ...
            <tbody className="divide-y divide-vintage-100">
              {periods.map((p) => (
                <tr key={p.id} className="hover:bg-vintage-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-sm text-vintage-700 text-center">{p.entryCount}</td>
