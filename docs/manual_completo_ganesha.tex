...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\color{branddark} Ganesha ERP v2.5}
...
\begin{titlepage}
    ...
    \begin{tcolorbox}[colback=brandgray,colframe=brandgray,arc=10pt,left=20pt,right=20pt,top=20pt,bottom=20pt]
        \centering
        \color{brandwhite}
        \Large\textbf{La Solución Integral de Contabilidad Bimonetaria y Asesoría Financiera Impulsada por Inteligencia Artificial}
    \end{tcolorbox}
